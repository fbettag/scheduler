...
func TestGet(t *testing.T) {
	...
	getResult, err := funcRegistry.Get("github.com/fbettag/scheduler/task.(*CallbackMock).CallNoArgs-fm")
...
func TestExists(t *testing.T) {
	...
	found = funcRegistry.Exists("github.com/fbettag/scheduler/task.(*CallbackMock).CallNoArgs-fm")
	if !found {
